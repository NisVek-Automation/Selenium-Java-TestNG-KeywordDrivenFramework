...
/**
 * This class helps to write the execution report.
...
public class ReportHelper {
	...
	public static String getReportDir() {
		return ConstantsHelper.reportFilePath;
	}
	...
	public static void startTesting(String filename, String testStartTime){//, String env, String rel) {
		...
		try {
			...
			out.write("<td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>" + ConstantsHelper.environment+ "</b></td>\n");
			out.write("</tr>\n");
			
			out.write("<tr>\n");
			out.write("<td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Release</b></td>\n");
			out.write("<td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>" + ConstantsHelper.release + "</b></td>\n");
			out.write("</tr>\n");
	...
	public static void startSuite(String suiteName) {
		...
		ReportHelper.suiteName = suiteName;
		FileWriter fstream = null;
		BufferedWriter out = null;
		tcid = 1;
		try {
